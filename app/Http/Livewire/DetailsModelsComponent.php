...
class DetailsModelsComponent extends Component
{
    ...
    public function render()
    {
        ...
        $brand = Product::where('brandcategory_id',$model->product->brandcategory_id)->first();
        return view('livewire.details-models-component',['model'=>$model,'network_products'=>$network_products,'product_models'=>$product_models,'series'=>$series,'types'=>$types,'jacket_products'=>$jacket_products,'network_images'=>$network_images,'brand'=>$brand])->layout("layout.navfoot");
    }
}
