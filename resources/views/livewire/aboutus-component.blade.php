...
<div style="min-height: calc(100vh - 227.5px);">
    ...
    <div class="container">
        ...
        <h1 style="text-align: center; margin-bottom: 3%; font-size: 50px;"><i class="bi bi-award"></i>Award</h1>
