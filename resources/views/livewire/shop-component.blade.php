            ...
            <div class="card swiper-slide">
                <div class="image-content">
                    <div class="card-image">
                        <a href="{{route('product.detailsmodels',['modelslug'=>$product->slug])}}"><img class="card-img" src="{{asset('/images/products')}}/{{$product->product->image}}" width="100%" height="100%"/></a>
                    </div>
                </div>
                <div class="card-content">
                    <a style="text-decoration: none" href="{{route('product.detailsmodels',['modelslug'=>$product->slug])}}"><h2 class="name">{{$product->slug}}, {{$product->name}}</h2></a>
