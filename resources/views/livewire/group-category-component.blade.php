            ...
            @foreach($models->where('group_products',$product->groupproduct_id) as $model)
                ...
                <div class="card">
                    <a href="{{route('product.detailsmodels',['modelslug'=>$model->slug])}}" class="card-wrapper">
                        <div class="boximgnp">
                            <div class="imgnp"><img src="{{asset('/images/products')}}/{{$model->image}}"></div>
                        </div>
                        <div class="card-body">
                    ...
                    <div class="card-footer">
                        ...
                        @else
                            <button id="add-cart-button" type='button' class="button btn" data-name="{{$model->slug}}"><span>เพิ่มลงตะกร้า</span></button>
                        @endif
                    </div>
                    </div>
                </div>
