            ...
            <div class="col-md-12">
                <div class="panel">
                    <div class="panel-heading">
                        <div class="row">
                            <div class="col-md-12" id="head">
                                <h2><a href="{{route('admin.AdminNewProducts')}}" style="color: black;"><i class="bi bi-arrow-left-circle-fill"></i></a>  EditNewProducts</h2>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="panel-body">
                        <form class="form-panel" enctype="multipart/form-data" wire:submit.prevent="updateNewProduct">
                            ...
                            <div class="form-group">
                                ...
                                @error('brand_id') <p class="text-danger">กรุณาใส่</p> @enderror
                            </div>
                            <div class="form-group">
