<div style="margin-left: 5%; margin-right: 5%">
    ...
    <div class="container" style="padding: 30px 0;">
        <div class="row">
            <div class="col-md-6">
                <h2><a href="{{route('admin.post.category')}}" style="color: black;"><i class="bi bi-arrow-left-circle-fill"></i></a>  Add New Post Category</h2>
            </div>
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        @endif
                        <form class="form-horizontal" wire:submit.prevent="storePostCategory">
