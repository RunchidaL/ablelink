        ...
        <form class="addproduct" wire:submit.prevent="updateGroup">
            <div class="row mb-3">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-12">
                        <select name="form-control input-md" wire:model="idgroup" wire:change="changeSeries">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-12">
                        <select name="form-control input-md" wire:model="series_c" wire:change="changeType">
                            <option value="">None</option>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-12">
                        <select name="form-control input-md" wire:model="types_c">
                            <option value="">None</option>
                ...
                <div class="form-group">
                    ...
                    <div class="row justify-content-start">
                        <div class="col-md-2">
                            <select name="form-control input-md" wire:model="jackets_c">
                                <option value="">None</option>
