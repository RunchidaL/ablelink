                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" wire:submit.prevent="customContact">
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <textarea type="text" class="form-control input-md" name="" id="" cols="20" rows="5" wire:model="Address"></textarea>
                                </div>
                            </div>

                            <br>
                            <div class="form-group">
                                <label class="col-md-4 control-label">Name: Facebook</label>
                                <div class="col-md-4">
                                    <input type="text" class="form-control input-md" wire:model="facebook">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-4 control-label">link-Facebook</label>
                                <div class="col-md-4">
                            ...
                            <br>
                            <div class="form-group">
                                <label class="col-md-4 control-label">Name: Line</label>
                                <div class="col-md-4">
                                    <input type="text" class="form-control input-md" wire:model="line">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-4 control-label">link-Line</label>
                                <div class="col-md-4">
                            ...
                            <br>
                            <div class="form-group">
                                <label class="col-md-4 control-label">Name: Youtube</label>
                                <div class="col-md-4">
                            ...
                            <br>
                            <div class="form-group">
                                <label class="col-md-4 control-label">Name: Email</label>
                                <div class="col-md-4">
                                    <input type="text" class="form-control input-md" wire:model="email">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-4 control-label">link-Email</label>
                                <div class="col-md-4">
                            ...
                            <br>
                            <div class="form-group">
                                <label class="col-md-4 control-label">link-Googlemap</label>
                                <div class="col-md-4">
